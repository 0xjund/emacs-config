...
;; Install SVG version of all-the-icons
...
;; Unicode support with unicode-fonts package
...
(use-package general
  ...
  (rune/leader-keys
    ...
    "fp" '(counsel-find-file :which-key "find file")
    "ff" '(counsel-find-file :which-key "find file")
    "fj" '(dired-jump :which-key "jump to dired")
    "."  '(counsel-find-file :which-key "find file")
    
    ;; Additional useful file bindings
...
;; Add solidity-flycheck for syntax checking
...
(with-eval-after-load 'lsp-mode
  ;; Add solidity language ID configuration
  (add-to-list 'lsp-language-id-configuration '(solidity-mode . "solidity"))
  
  ;; Set solidity server command
  (setq lsp-solidity-server-command '("nomicfoundation-solidity-language-server" "--stdio"))
  
  ;; Set solidity include paths
  (setq lsp-solidity-include-path ["lib" "node_modules" "src" "test" "script"])
...
;; Auto-enable LSP for solidity-mode
